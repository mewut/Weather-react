export const Cities = [
    ...
    { value: 'Camayenne', label: 'Camayenne' },
    ...
    { value: 'Kingsburg', label: 'Kingsburg' },
    ...
    { value: 'Mamoudzou', label: 'Mamoudzou' },
    ...
    { value: 'Nay Pyi Taw', label: 'Nay Pyi Taw' },
    ...
    { value: 'Oranjestad', label: 'Oranjestad' },
    ...
    { value: 'Saint Helier', label: 'Saint Helier' },
    { value: 'Saint John"s', label: 'Saint John"s' },
    { value: 'Saint Peter Port', label: 'Saint Peter Port' },
    ...
    { value: 'Santa Cruz de la Sierra', label: 'Santa Cruz de la Sierra' },
  ...
  export const Period = [
      { value: 'weather', label: 'В настоящее время' },
      { value: 'forecast', label: 'На следующие 5 дней' },
    ]